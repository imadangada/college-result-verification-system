...
?>
 <h3 class="info"><?php echo $cntcourse;?></h3>
                      <h6>Total Number Of Courses Registered</h6>
                    </div>
                    <div>
              ...
              <div class="card-content">
                ...
                <div class="card-body">
                  <div class="media d-flex">
                    <div class="media-body text-left">
<?php 
$wer =mysqli_query($con ,"SELECT dept_id from department");
$cntuser=mysqli_num_rows($wer);
 ?>
 <h3 class="warning"><?php echo $cntuser;?></h3>
                      <h6>Total Department Registered</h6>
                    </div>
                    <div>
              ...
              <div class="card-content">
                ...
                <div class="card-body">
                  <div class="media d-flex">
                    <div class="media-body text-left">
<?php 
$ter =mysqli_query($con ,"SELECT id from cert");
$cntapp=mysqli_num_rows($ter);
?>

<h3 class="success"><?php echo $cntapp ;?></h3>
                      <h6>Total Student Verified</h6>
                    </div>
                    <div>
                      <i class="icon-user-follow success font-large-2 float-right"></i>
                    </div>
