...
data-open="click" data-menu="vertical-menu" data-col="1-column">
        ...
        <ul class="nav navbar-nav flex-row">
          ...
          <li class="nav-item">
            <a class="navbar-brand" href="../index.php">
              ...
              <h3 class="brand-text">Student Verification | Admin login</h3>
            </a>
          </li>
  ...
  <footer class="footer fixed-bottom footer-dark navbar-border navbar-shadow">
    <p class="clearfix blue-grey lighten-2 text-sm-center mb-0 px-2">
      <span class="float-md-left d-block d-md-inline-block">Copyright &copy; 2021 <a class="text-bold-800 grey darken-2" >Student Verification </a>, All rights reserved. </span>
