...
$msg="This email or Contact Number already associated with another account";
    ...
    $query=mysqli_query($con, "insert into tbladmin(AdminName, AdminuserName,MobileNumber, Email,  Password) value('$AdminName', '$AdminuserName','$contno', '$email', '$password' )");
    if ($query) {
                      ...
                      <div class="row">
                        <div class="col-12 col-sm-6 col-md-6">
                          <fieldset class="form-group position-relative has-icon-left">
                            <input type="text" name="AdminName" id="firstname" required="true" class="form-control input-lg"
                        ...
                        <div class="col-12 col-sm-6 col-md-6">
                          <fieldset class="form-group position-relative has-icon-left">
                            <input type="text" name="AdminuserName" id="lastname" required="true" class="form-control input-lg"
